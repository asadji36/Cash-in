    ...
    <footer className="bg-dark-card border-t border-gray-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Your trusted multi-affiliate platform for finding the best deals across Amazon, Daraz, AliExpress, eBay, and Walmart.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} As Multi. All rights reserved.</p>
          <p className="mt-2 text-sm">
            We earn commissions from qualifying purchases made through affiliate links on this site.
          </p>
        </div>
      </div>
    </footer>
